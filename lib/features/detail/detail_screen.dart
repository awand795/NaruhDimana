...
class _DetailScreenState extends ConsumerState<DetailScreen> {
  ...
  String _getCategoryName() {
    ...
    return findCategoryBySlugOrFallback(
            mergedAsync.valueOrNull ?? [], _item.category)
        .name;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final category =
        findCategoryBySlugOrFallback(allCategories, _item.category);
    final catColor =
        AppTheme.getCategoryColor(_item.category, context);
              ...
              background: Stack(
                children: [
                  Hero(
                      ...
                      child:
                          _buildImageBackground(category, catColor)),
                  Positioned.fill(
                    child: Container(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow:
                          AppTheme.glowShadow(catColor, alpha: 0.15),
                    ),
                  ...
                  _InfoCard(
                    ...
                    children: [
                      ...
                      _DetailInfoRow(
                          ...
                          title: 'DITAMBAHKAN',
                          subtitle: DateFormat(
                                  'dd MMMM yyyy, HH:mm', 'id')
                              .format(
                                  DateTime.parse(_item.createdAt)),
                          catColor: catColor),
                    ],
                  ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(
                              AppTheme.radiusL),
                          boxShadow:
                              AppTheme.softShadow(alpha: 0.06),
                        ),
                              ...
                              Text(
                                  ...
                                  style: const TextStyle(
                                      fontWeight:
                                          FontWeight.w500,
                                      color: Colors.white)),
                              if (_item.reminderRepeat !=
                                  'none')
                                Text(
                                    _item.reminderRepeat ==
                                            'daily'
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: Text(_item.reminderTime != null
                          ? 'Ubah Pengingat'
                          : 'Atur Pengingat'),
                    ),
                  ),
  ...
  Widget _buildImageBackground(
      MergedCategory category, Color catColor) {
    ...
    if (allPaths.length <= 1) {
      return Image.file(File(allPaths.first),
          fit: BoxFit.cover,
  ...
  Widget _buildPlaceholder(
    ...
    return Container(
        ...
        child: Center(
            child:
                Icon(category.icon, size: 80, color: catColor)));
  }
}
