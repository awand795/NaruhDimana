...
class Item {
  ...
  factory Item.fromMap(Map<String, dynamic> map) {
    List<String>? paths;
    if (map['photo_paths'] != null && (map['photo_paths'] as String).isNotEmpty) {
      try {
        paths = List<String>.from(jsonDecode(map['photo_paths'] as String));
      } catch (_) {
        paths = [];
      }
    }
  ...
  Item copyWith({
    ...
    return Item(
      ...
      photoPaths: photoPaths == _unset ? this.photoPaths : photoPaths as List<String>?,
